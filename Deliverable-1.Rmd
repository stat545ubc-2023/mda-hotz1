...
For each of the four selected datasets which we are going to look into further, we will first look at the total number of missing and recorded (not missing) values per column.

This will give us a better understanding of which columns are likely or unlikely to contain data in each of the datasets, and it will also allow us to have a look at the different variables which are stored in each of the four selected datasets.
